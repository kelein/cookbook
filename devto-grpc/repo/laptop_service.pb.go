...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x54, 0x79, 0x70, 0x65, 0x32, 0xf0, 0x01, 0x0a, 0x0d, 0x4c, 0x61, 0x70, 0x74, 0x6f,
	...
	0x12, 0x47, 0x0a, 0x0b, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x12,
	...
	0x73, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2f, 0x72,
...
var file_laptop_service_proto_depIdxs = []int32{
	...
	5, // 9: proto.LaptopService.UploadImage:output_type -> proto.UploadImageResonse
...
func (x *laptopServiceUploadImageClient) CloseAndRecv() (*UploadImageResonse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(UploadImageResonse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (x *laptopServiceUploadImageServer) SendAndClose(m *UploadImageResonse) error {
	return x.ServerStream.SendMsg(m)
}
